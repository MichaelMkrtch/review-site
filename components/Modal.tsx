...
export default function Modal({
  ...
  if (hasPadding) {
    ...
    classes =
      "w-4/5 max-w-[50%] overflow-hidden rounded-xl bg-[#181818] text-zinc-200 outline-none drop-shadow-lg backdrop:bg-[#000] backdrop:opacity-70 open:animate-enter open:backdrop:animate-fadein";
  }
